...
Sce[[2]]$experiment_group <- "bfc"
Sce[[2]]$healthy_status <- "fibrosis"

Sce[[3]]$author <- "buonomo"
Sce[[3]]$experiment_group <- "bhc"
Sce[[3]]$healthy_status <- "healthy"

Sce[[4]]$author <- "buonomo"
Sce[[4]]$experiment_group <- "bhc"
Sce[[4]]$healthy_status <- "healthy"
...
Sce[[6]]$author <- "zhang"
Sce[[6]]$experiment_group <- "zfc"
Sce[[6]]$healthy_status <- "fibrosis"
...
Sce[[8]]$author <- "zhang"
Sce[[8]]$experiment_group <- "zhc"
Sce[[8]]$healthy_status <- "healthy"
...
Sce[[10]]$experiment_group <- "tfc"
Sce[[10]]$healthy_status <- "fibrosis"

Sce[[11]]$author <- "tamburini"
Sce[[11]]$experiment_group <- "thc"
Sce[[11]]$healthy_status <- "healthy"

Sce[[12]]$author <- "tamburini"
Sce[[12]]$experiment_group <- "thc"
Sce[[12]]$healthy_status <- "healthy"
...
Sce[[15]]$experiment_group <- "rfc"
Sce[[15]]$healthy_status <- "fibrosis"
...
Sce[[18]]$author <- "ramachandran"
Sce[[18]]$experiment_group <- "rhc"
Sce[[18]]$healthy_status <- "healthy"
...
Sce[[20]]$experiment_group <- "gfc"
Sce[[20]]$healthy_status <- "fibrosis"

Sce[[21]]$author <- "guilliams"
Sce[[21]]$experiment_group <- "ghc"
Sce[[21]]$healthy_status <- "healthy"

Sce[[22]]$author <- "guilliams"
Sce[[22]]$experiment_group <- "ghc"
Sce[[22]]$healthy_status <- "healthy"
Sce[[22]]$patient <- "ghc_p3"
