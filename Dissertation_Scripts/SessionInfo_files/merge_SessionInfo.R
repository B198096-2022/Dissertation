...
[1] patchwork_1.1.2    dplyr_1.1.1        Seurat_4.3.0       SeuratObject_4.1.3
[5] sp_1.6-0          
...
loaded via a namespace (and not attached):
 ...
 [13] splines_4.2.3          knitr_1.42             polyclip_1.10-4       
 [16] spam_2.9-1             jsonlite_1.8.4         ica_1.0-3             
 [19] cluster_2.1.4          png_0.1-8              uwot_0.1.14           
 [22] shiny_1.7.4            sctransform_0.3.5      spatstat.sparse_3.0-1 
 [25] compiler_4.2.3         httr_1.4.5             Matrix_1.5-4          
 [28] fastmap_1.1.1          lazyeval_0.2.2         cli_3.6.1             
 [31] later_1.3.1            htmltools_0.5.5        tools_4.2.3           
 [34] igraph_1.4.2           dotCall64_1.0-2        gtable_0.3.3          
 ...
 [73] evaluate_0.20          lattice_0.21-8         ROCR_1.0-11           
 [76] purrr_1.0.1            tensor_1.5             htmlwidgets_1.6.2     
 ...
 [88] fitdistrplus_1.1-11    survival_3.5-5         abind_1.4-5           
 [91] tibble_3.2.1           future.apply_1.10.0    KernSmooth_2.23-20    
 [94] utf8_1.2.3             spatstat.geom_3.1-0    plotly_4.10.1         
 [97] rmarkdown_2.21         grid_4.2.3             data.table_1.14.8     
[100] digest_0.6.31          xtable_1.8-4           tidyr_1.3.0           
[103] httpuv_1.6.9           munsell_0.5.0          viridisLite_0.4.2  
