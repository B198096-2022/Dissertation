...
#######################################################################
#                                                                     #
#                   Specify location of Seruat Package                #
#                                                                     #
####################################################################### 
...
sample_name <- "<author>_<helathy/fibrosis>_"  #depdning on how data sets were labeled also add cell/nuc
sample_label <- "<sample_label>" #Example "zhc" for zhang_healthy_cell
exp_group <- "<healthy/fibrosis>"
