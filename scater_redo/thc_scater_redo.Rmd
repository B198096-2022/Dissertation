...
dir <- "/Volumes/cmvm/scs/groups/pramacha-GROUP/Max_Hammer/cellranger/"
datadir <- dir
outdir <- paste0("/Volumes/cmvm/scs/groups/pramacha-GROUP/Max_Hammer/scater/",sample_author,"/")
fig_path <- paste0("~/Desktop/scater/",sample_author,"/")
...
## Filter for mt%/count/feature past 3 nmad 
...
#vln plot
for (i in range){
  sub <- subset(Sce[[1]], final_outlier == "FALSE")
