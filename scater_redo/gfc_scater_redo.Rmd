...
#Where to find the cell ranger outputs 
...
#Patient IDs 
patient <- c("gfc_p1", "gfc_p2", "gfc_p2", "gfc_p3", "gfc_p4", "gfc_p4")
...
fibrosis_score <- c("unknown", "unknown", "unknown", "unknown", "unknown", "unknown")
